...
iaas_vm_create_119 = 'The "cpu" parameter is invalid. "cpu" must be within the range 1 to 24 inclusive.'
...
iaas_vm_create_122 = 'The "ram" parameter is invalid. "ram" must be within the range 1 to 128 inclusive.'
...
iaas_vm_create_136 = (
    'There are currently no available VLANs to allow this VM to utilise Cloud Init services. Please contact CloudCIX '
    'Support.'
)
iaas_vm_create_137 = (
    'There are currently no available IP Addresses to allow this VM to utilise Cloud Init services. Please contact '
    'CloudCIX Support.'
)
iaas_vm_create_138 = 'The "ip_addresses" parameter is invalid. All IPs in the list  must be a valid IP Address.'
iaas_vm_create_139 = 'The "ip_addresses" parameter is invalid. All IPs in the list must be a private IP Address.'
iaas_vm_create_140 = (
...
iaas_vm_create_146 = 'The `userdata` parameter is invalid. `userdata` must not exceed 16 KB in size.'
iaas_vm_create_147 = (
...
iaas_vm_create_201 = 'You do not have permission to make this request. Your Member must be self managed.'
...
iaas_vm_update_110 = 'The "ip_addresses" parameter is invalid. "ip_addresses" is required and cannot be an empty list.'
iaas_vm_update_111 = (
    'The `ip_addresses` parameter is invalid.  You can only NAT IPs from the "gateway_subnet" of the VM.'
)
iaas_vm_update_112 = (
...
iaas_vm_update_113 = 'The "ip_addresses" parameter is invalid.  One of the supplied IPs in the list does not exist.'
iaas_vm_update_114 = 'The "cpu" parameter is invalid. "cpu" must be a valid integer.'
iaas_vm_update_115 = 'The "cpu" parameter is invalid. "cpu" must be within the range 1 to 24 inclusive.'
iaas_vm_update_116 = (
...
iaas_vm_update_119 = 'The "ram" parameter is invalid. "ram" must be a valid integer.'
iaas_vm_update_120 = 'The "ram" parameter is invalid. "ram" must be within the range 1 to 128 inclusive.'
iaas_vm_update_121 = (
...
iaas_vm_update_124 = 'The "storages" parameter is invalid. "storages" must be a list.'
iaas_vm_update_125 = 'This "storage" is invalid. Items in "storages" must be objects / dictionaries.'
iaas_vm_update_126 = (
    'This "storage" is invalid. As part of the VM update request, you cannot create new primary "storage" records.'
)
iaas_vm_update_127 = 'This "storage" is invalid. The given "id" does not correspond with an existing Storage record.'
iaas_vm_update_128 = (
...
iaas_vm_update_132 = 'The `userdata` parameter is invalid. `userdata` must not exceed 16 KB in size'
iaas_vm_update_133 = (
    'The `userdata` parameter is invalid. `userdata` must be one of the file formats allowed by Cloud Init. The full '
    'list of formats can be found at this url: https://cloudinit.readthedocs.io/en/latest/topics/format.html'
)
