...
iaas_backup_create_103 = (
    'The "vm_id" parameter is invalid. Backups can only be created of a VM that is in a RUNNING or QUIESCED state.'
)
...
iaas_backup_read_203 = (
    'You do not have permission to make this request. Can only read Backups of a VM that you own.'
)
# update
...
iaas_backup_update_107 = (
    'The "state" parameter is invalid. "state" parameter of Backup can only updated if the VM is in a RUNNING or '
    'QUIESCED state".'
)
