...
class Permissions:
    ...
    """
    @staticmethod
    def head(request: Request, obj: VPN, span: Span) -> Optional[Http403]:
        """
        The request to access a VPN is valid if;
    ...
    def update(request: Request, obj: VPN) -> Optional[Http403]:
        ...
        if request.user.robot:
            ...
            if request.user.address['id'] != obj.virtual_router.project.address_id:
